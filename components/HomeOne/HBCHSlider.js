    ...
    return (
        <>
            ...
            >
                ...
                <div className="new-slider-item-hbch new-slider-item-img-hbch">
                ...
                <div className="new-slider-item-hbch-2 slider-item-img-hbch-2">
                    <div className="d-table">
                        <div className="d-table-cell">
                ...
                <div className="new-slider-item-hbch-3 slider-item-img-hbch-3">
                    <div className="d-table">
                        <div className="d-table-cell">
                            <div className="container">
                                <div className="slider-text">
                ...
                <div className="new-slider-item-hbch-4 slider-item-img-hbch-4">
                    <div className="d-table">
                        <div className="d-table-cell">
                            <div className="container">
                                <div className="slider-text">
                ...
                <div className="new-slider-item-hbch-5 slider-item-img-hbch-5">
                    <div className="d-table">
                        <div className="d-table-cell">
                            <div className="container">
                                <div className="slider-text">
